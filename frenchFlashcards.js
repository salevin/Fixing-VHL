...
elt.innerHTML = "$(document).keydown(function(e){if (e.keyCode==90 && e.ctrlKey){mark_incorrect();}if (e.keyCode==88 && e.ctrlKey){mark_correct();}if (e.keyCode==86 && e.ctrlKey){toggle_vocab('word');}});";
